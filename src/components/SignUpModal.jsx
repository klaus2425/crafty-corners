...
export default function SignUpModal(props) {
    ...
    const options = [
        ...
        {
            value: "Bachelor of Science in Industrial Technology",
            label: "Bachelor of Science in Industrial Technology"
        },
        ...
        {
            value: "Bachelor of Science in Industrial Engineering",
        ...
        {
            value: "Bachelor of Science in Exercise and Sports Science",
            label: "Bachelor of Science in Exercise and Sports Science"
        }
    ];
            ...
            <div className='overlay'>
                <div className='modal' id='sign-up-modal'>
                    <div className='close-login close-signup'>
                        <h2>Sign Up</h2>
                        <svg onClick={() => {
                            props.setIsOpen(false), setImage(null)
                    ...
                    <form encType="multipart/form-data" onSubmit={onSubmit}>
                            ...
                            <div className="signup-inputs">
                                ...
                                <div className="right">
                                    <label className='flex align-center sign-phone-label'>Phone Number:
                                        <svg style={{ width: 'fit-content' }} width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        <div className="card"> This phone number will serve as your GCash number for
                                            receiving tips/donations as a mentor
                                        </div>
                                    </label>
                                    <input className='phoneNumberInput' id='phoneNumberInput'
                                           onChange={handleInputNumberChange} value={inputValue} ref={numberRef}
                                           required/>
                        ...
                        <div className="sign-up-button-container">
                            <div className={'terms-input-container'}>
                                <input onChange={() => setAccepted(!accepted)} type="checkbox"/>
                                <p>
                                    I have accepted the <span className='terms-conditions'
                                                              onClick={() => setIsTermsOpen(true)}>
                                    Terms and Conditions</span> and <span className="terms-conditions"
                                                                          onClick={() => setIsPolicyOpen(true)}>Privacy Policy</span> for
                                    Crafty Corners.
                                </p>
                            </div>

                            <button className='btn btn--purple' style={{
                                backgroundColor: accepted ? "#6339DC" : "#a692d9",
                                cursor: accepted ? 'pointer' : 'auto',
                    ...
                    <div className="overlay">
                        <div className="modal terms-modal">
                            <div className='close-login close-signup'>
                                ...
                                <svg onClick={() => setIsTermsOpen(false)} xmlns="http://www.w3.org/2000/svg" width="30"
                            ...
                            <h3>Introduction</h3>
                            <p>
                                Welcome to Crafty Corners, a website dedicated to cultivating different hobbies for BPSU
                                (Bataan
                                Peninsula State University) students with the aid of collaborative filtering technology.
                                Before using
                                our services, please carefully read and understand the following terms and conditions:
                            </p>
                            <p>
                                <strong>1. Acceptance of Terms:</strong> By accessing or using Crafty Corners, you agree
                                to be bound by these
                                Terms & Conditions, as well as any additional terms and policies referenced herein.
                            </p>
                            <p>
                                <strong>2. Use of Services:</strong> Crafty Corners provides a platform for BPSU
                                students to discover and engage
                                in various hobbies through collaborative filtering technology. Users are solely
                                responsible for their
                                interactions and activities on the website.
                            </p>
                            <p>
                                <strong>3. Registration:</strong> Some features of Crafty Corners may require user
                                registration. By registering, you
                            ...
                            <p>
                                <strong>4. User Content:</strong> Users may contribute content such as hobby
                                recommendations, reviews, and
                                comments. By submitting content to Crafty Corners, you grant us a non-exclusive,
                                royalty-free,
                                perpetual, and worldwide license to use, modify, publish, and distribute your content
                                for any
                                purpose.
                            </p>
                            <p>
                                <strong>5. Plagiarism:</strong> Users must not engage in plagiarism or using someone
                                else's work without giving
                                proper credit and claiming it as the original owner
                            </p>
                            <p>
                                <strong>6. Collaborative Filtering:</strong> Crafty Corners utilizes collaborative
                                filtering technology to
                                recommend hobbies based on user preferences and interactions. While we strive to provide
                                accurate recommendations, we cannot guarantee the accuracy, completeness, or reliability
                                of the
                                recommendations.
                            </p>

                            <p>
                                <strong>7. Prohibited Activities:</strong> Users agree not to engage in any of the
                                following activities:
                                <ul>
                                    <li>Violating any applicable laws or regulations.</li>
                                    <li>Interfering with the operation of Crafty Corners or the rights of other users.
                                    </li>
                            ...
                            <p>
                                <strong>8. Privacy Policy:</strong> Crafty Corners respects your privacy and handles
                                your personal information in
                                accordance with our <span className="terms-conditions"
                                                          onClick={() => setIsPolicyOpen(true)}>Privacy Policy</span>,
                                which is incorporated herein by reference.
                            </p>
                            <p>
                                <strong>9. Termination:</strong> Crafty Corners reserves the right to suspend or
                                terminate your access to the
                                website at any time, with cause, and with prior notice.
                            </p>
                            <p>
                                <strong>10. Disclaimer of Warranties:</strong> Crafty Corners do not guarantee that the
                                website will be error-free
                                or uninterrupted. The user will bear sole risk for use.
                            </p>
                            <p>
                                <strong>11. Limitation of Liability:</strong> In no event shall Crafty Corners or its
                            ...
                            <p>
                                <strong>12. Governing Law:</strong> These Terms & Conditions shall be governed by and
                                construed in accordance
                                with the laws of the jurisdiction where Crafty Corners operates.
                            </p>
                            <p>
                                <strong>13. Changes to Terms:</strong> Crafty Corners reserves the right to update or
                                modify these Terms &
                            ...
                            <footer>
                                ...
                                <button className='btn btn--purple' onClick={() => setIsTermsOpen(false)}>Accept
                                </button>
                            </footer>
                        </div>
                    </div>
                    ...
                    <div className="overlay">
                        <div className="modal terms-modal">
                            <div className='close-login close-signup'>
                                ...
                                <svg onClick={() => setIsPolicyOpen(false)} xmlns="http://www.w3.org/2000/svg"
                            ...
                            <p>
                                ...
                                describes how we collect, use, and disclose information when you visit our website
                                www.craftycorners.online.
                            </p>

                            <p>
                                <strong>1. Information We Collect <br/></strong> We may collect personal information
                                ...
                                <ul>
                                    <li>Personal Information: When you register on Crafty Corners, we gather your name,
                                        BPSU email address, and BPSU student ID. We may also collect other information
                                        that you
                                    </li>
                                    <li>Usage Information: We gather data about your interactions with Crafty Corners
                                    </li>
                                    <li>Device Information: We may collect information about the device you use to visit
                                        Crafty
                                        Corners, such as its kind, operating system, and browser type
                                    </li>
                                </ul>
                            </p>

                            <p>
                                <strong>2. Use of Information <br/></strong> We may use the information we collect for
                                the following purposes:
                                <ul>
                                    <li>Personalization: We use the information collected to personalize your experience
                                        on
                                        Crafty Corners, including recommending hobbies and content based on your
                                        interests and
                                        preferences
                                    </li>
                                    <li> Usage Information: We gather data about your interactions with Crafty
                                        Corners.
                                    </li>
                                    <li>Device Information: We may collect information about the device you use to visit
                                        Crafty
                            ...
                            <p>
                                <strong>4. Sharing of Information</strong> <br/> We may share your information with
                                third parties for the following purposes:
                                <ul>
                                    <li>With service providers who assist us in operating our Site and providing our
                                        services.
                                    </li>
                                    <li>With third-party vendors, consultants, and other service providers who need
                                        access to such information to perform services on our behalf.
                                    </li>
                                    <li>With law enforcement authorities or other government officials if required by
                                        law or to protect our rights or the rights of others.
                                    </li>
                                </ul>
                            </p>
                            <p>
                                <strong>5. Changes to this Privacy Policy</strong> <br/>We may update this Privacy
                                Policy from time to time, and any changes will be posted on this page. Please review
                            ...
                            <footer>
                                ...
                                <button className='btn btn--purple' onClick={() => setIsPolicyOpen(false)}>Accept
                                </button>
                            </footer>
                        </div>
                    </div>
