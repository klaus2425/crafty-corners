    ...
    useEffect(() => {
        echo.private(`user-${user.id}`)
            .listen('MessageSent', (data) => {
                if (window.location.pathname == `/conversation/${data.message.conversation_id}`) {
            ...
            .listen('MentorshipApplicationStatus', () => {
                queryClient.invalidateQueries({ queryKey: ['notifications'] });
                if (window.location.pathname != '/notifications') {
                    setHasNotification(true);
                } else {
            ...
            .listen('ReportResolvedNotification', () => {
                queryClient.invalidateQueries({ queryKey: ['notifications'] });
                if (window.location.pathname != '/notifications') {
                    setHasNotification(true);
                } else {
        ...
        <aside className="sidebar">
            <div className='sidebar-upper'>
                ...
                <div className="sidebar-link" onClick={() => {
                    ...
                    {
                        hasNotification ?
                            <svg id='notification-icon' width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <div className='sidebar-lower'>
                ...
                <div className="sidebar-link" onClick={() => navigate(`/communities`)}>
                ...
                <div className={`sidebar-link`} onClick={() => setIsOpen(!isOpen)}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            fill="#222222"/>
                        <path d="M20 21H10" stroke="#222222" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
