        ...
        <div className="authenticated-container">
            ...
            <div className='section-header'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                        ...
                        <path d="M24.1667 35V26.6667C24.1667 25.7462 23.4205 25 22.5 25H17.5C16.5796 25 15.8334 25.7462 15.8334 26.6667V35" stroke="#677186" strokeWidth="3.33333" stroke-linecap="round" strokeLinejoin="round"/>
                    </svg>
                    <h3>Home</h3>
            </div>
                {<Posts/>}
