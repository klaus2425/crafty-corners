                  ...
                  <div className="video-btm-text">
                    <div className='title-likes'>
                      ...
                      <div className='v-likes'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <path d="M8.85 19H6C5.44772 19 5 18.5523 5 18V12C5 11.4477 5.44772 11 6 11H8.85C8.93284 11 9 11.0672 9 11.15V18.85C9 18.9328 8.93284 19 8.85 19Z" stroke="#33363F" stroke-width="2" stroke-linecap="round"/>
