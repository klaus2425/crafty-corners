                ...
                <label className='upload-attachment-icon' htmlFor="upload-button">
                  <label onClick={() => setIsEmojiOpen(!isEmojiOpen)} ref={menuRefIcon} className='upload-emoji-icon'>
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="5" cy="5" r="3.95833" stroke="#222222" stroke-width="0.416667" stroke-linecap="round" />
                      <circle cx="3.74998" cy="4.16667" r="0.416667" fill="#222222" stroke="#222222" stroke-width="0.416667" stroke-linecap="round" />
                      <circle cx="6.24998" cy="4.16667" r="0.416667" fill="#222222" stroke="#222222" stroke-width="0.416667" stroke-linecap="round" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M3.59537 6.25C3.47879 6.25 3.42051 6.25 3.38941 6.29449C3.35831 6.33898 3.37634 6.38825 3.4124 6.48679C3.62744 7.07453 4.25693 7.50003 5.00001 7.50003C5.74308 7.50003 6.37258 7.07453 6.58762 6.48679C6.62367 6.38825 6.6417 6.33898 6.6106 6.29449C6.57951 6.25 6.52122 6.25 6.40465 6.25H3.59537Z" fill="#222222" />
                    </svg>
                  </label>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
