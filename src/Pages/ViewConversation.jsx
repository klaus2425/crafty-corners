  ...
  useEffect(() => {
    ...
    echo.private(`conversation-${conversation_id}`)
      ...
      .listen('MessageSent', (data) => {
          ...
          console.log(`From user-${uid} notification channel to`,data);
      })
                                      ...
                                      <div className='flex flex--column' key={attachment.id}>
                                        <a download={'download'} href={`${import.meta.env.VITE_API_MESSAGES_URL}${attachment.file_path}`}>
                                          <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M26 36.5L41 36.5" stroke="#222222" stroke-width="3" stroke-linecap="round" />
                                            <path d="M29 43L39 43" stroke="#222222" stroke-width="3" stroke-linecap="round" />
